...
enum class HeaterAlde : uint8_t {
  HEATER_ALDE_OFF = 0x00,
  HEATER_ALDE_ON = 0x01,
};

enum class WaterTempAlde : uint8_t {
  WATER_TEMP_ALDE_OFF = 0,
  WATER_TEMP_ALDE_NORMAL = 100,
  WATER_TEMP_ALDE_BOOST = 200,
};

enum class ElectricPowerLevelAlde : uint8_t {
