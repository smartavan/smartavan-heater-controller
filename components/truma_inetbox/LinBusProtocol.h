...
class LinBusProtocol : public LinBusListener {
 public:
  ...
  virtual const std::array<uint8_t, 3> lin_identifier_version() = 0;
 ...
 private:
  ...
  void prepare_update_msg_high_prio_(const std::array<uint8_t, 8> message) {
